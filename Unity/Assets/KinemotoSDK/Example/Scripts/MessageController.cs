...
public class MessageController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        message[7] = Resources.Load("Sound/Message/Careful") as AudioClip;
        //message[8] = Resources.Load("Sound/Message/JoGum") as AudioClip;
        message[9] = Resources.Load("Sound/Message/LastOne") as AudioClip;
        message[10] = Resources.Load("Sound/Message/LeftArmFront") as AudioClip;
        ...
        message[13] = Resources.Load("Sound/Message/RightArmFront") as AudioClip;
