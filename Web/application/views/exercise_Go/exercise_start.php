...
<div class="container-fluid">
    <div class="row" style="margin: auto">
        <div class="col-md-12" style="margin-bottom: 10px;background-color:#3498db;">
            <div class="col-md-3">
                <div class="row" style="margin: auto">
            ...
            <div class="col-md-3">
                <div class="row" style="margin: auto">
                    <div
                        style="font-family: HANYG0230;height: 80px;padding: 1px;margin-top: 20px;height: 85px;float:right;"
                        id="information">
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin: auto">
                <div class="panel panel-success">
                    <div class="panel-body"
                         style="font-family: HANYG0230; padding-bottom: 1px; position: relative;height: 611px">
