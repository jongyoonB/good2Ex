...
public class DumbelCoordinator : MonoBehaviour
{
    ...
    public void dumbelboolClear()
    {
        dumbel.AllDepth = false;
        dumbel.AllGup = false;
        dumbel.AllSonmok = false;
        dumbel.GanBaRe = false;
        dumbel.Good = false;
        dumbel.Jinji = false;
        dumbel.JoGum = false;
        dumbel.LastOne = false;
        dumbel.LeftDepth = false;
        dumbel.LeftGup = false;
        dumbel.LeftSonMok = false;
        dumbel.RightDepth = false;
        dumbel.RightGup = false;
        dumbel.RightSonmok = false;
        dumbel.Starts = false;
    }
    ...
    void textController()
    {
        GameObject.Find("elbowLeftDegree").GetComponent<Text>().text = ((int)dumbel.elbow_Right_Angle).ToString();
        GameObject.Find("elbowRightDegree").GetComponent<Text>().text = ((int)dumbel.elbow_Left_Angle).ToString();
        GameObject.Find("armpLeftDegree").GetComponent<Text>().text = ((int)dumbel.armpit_Left_Angle).ToString();
        GameObject.Find("armpRightDegree").GetComponent<Text>().text = ((int)dumbel.armpit_Right_Angle).ToString();
